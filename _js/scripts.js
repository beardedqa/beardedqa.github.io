...
$( "#contactForm" ).submit( function( e ) {
    ...
    $.ajax( {
        ...
        url: "https://formspree.io/beardedqa@gmail.com",
        method: "POST",
        data: $( this ).serialize(),
        dataType: "json",
        ...
        success: function( data ) {
            ...
            $btn.text( "Send" );
            openModal();
            $( ".modal__body" ).append( "<h1>Thanks " + $name + "!</h1><p>My bearded post pigeon took your message! I will reply as soon as possible.</p>" );
